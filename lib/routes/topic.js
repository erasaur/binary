TopicController = RouteController.extend({
  subscriptions: function () {
    ...
    return [
      ...
      Meteor.subscribe('topicComments', topicId, sortBy, 'pro', SessionAmplify.get('itemsLimit')),
      Meteor.subscribe('topicComments', topicId, sortBy, 'con', SessionAmplify.get('itemsLimit')),
