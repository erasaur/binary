TopicController = RouteController.extend({
  subscriptions: function () {
    return [
      ...
      Meteor.subscribe('topicComments', this.params._id, this.params.query.sort_by, 'pro', Session.get('itemsLimit')/2),
      Meteor.subscribe('topicComments', this.params._id, this.params.query.sort_by, 'con', Session.get('itemsLimit')/2)
    ];
  },
  onRun: function () {
