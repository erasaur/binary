TopicController = RouteController.extend({
  subscriptions: function () {
    ...
    var sortBy = this.params.query && this.params.query.sort_by;
    ...
    return [
      ...
      subs.subscribe('topicComments', topicId, sortBy, 'pro', limit),
      subs.subscribe('topicComments', topicId, sortBy, 'con', limit),
      subs.subscribe('commentReplies', replies, sortBy)
    ];
  },
  onRun: function () {
